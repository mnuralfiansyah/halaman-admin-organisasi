...
<head>
    ...
    <title>Tambah Program Kerja Halaman Admin Organisasi</title>
    <!-- Favicon-->
...
<?php } ?>							
                        ...
                        <div class="body">
                            <form class="form-horizontal" method="POST" action="tambahprogramkerja1.php">
                                <div class="row clearfix">
                                    <div class="col-lg-2 col-md-2 col-sm-4 col-xs-5 form-control-label">
                                        <label for="email_address_2">Nama Program</label>
                                    </div>
                                ...
                                <div class="row clearfix">
                                    ...
                                    <div class="col-lg-10 col-md-10 col-sm-8 col-xs-7">
                                        <div class="form-group">
                                            <div class="form-line">
                                                <input type="text" name="tujuan" id="email_address_2" class="form-control" >
                                            </div>
                                        </div>
                                    </div>
                                </div>
										...
										<label for="email_address_2">jenis</label>
												...
												<div class="body">
													<div class="demo-radio-button">
														<input name="jenis" value="mingguan" type="radio" id="radio_1"  />
														<label for="radio_1">Mingguan</label>
														<input name="jenis" value="bulanan"type="radio" id="radio_2" />
														<label for="radio_2">Bulanan</label>
														<input name="jenis" value="tahunan"type="radio" id="radio_5" />
                                ...
                                <div class="row clearfix">
                                    <div class="col-lg-offset-2 col-md-offset-2 col-sm-offset-4 col-xs-offset-5">
                                         <button type="submit" class="btn btn-primary m-t-15 waves-effect">Tambah Data Program Kerja</button>
                                    </div>
                                </div>
                            </form>
                        </div>
