...
<head>
    ...
    <title>Data Pengurus Dan Kader Halaman Admin Organisasi</title>
    <!-- Favicon-->
...
<?php if (($jabatan=='Administrator') || ($jabatan=='super admin'))
		{ ?>
										<td>
											<a href="editanggota.php?id=<?php echo "$id";?>"><button type="button" class="btn bg-blue waves-effect"><i class="material-icons">edit</i></button></a>
										</td>
										<td>
											<a href="deleteanggota.php?id=<?php echo "$id";?>"><button type="button" class="btn bg-red waves-effect"><i class="material-icons">delete</i></button></a>
										</td>
