...
<head>
    ...
    <title>Tambah Keuangan Halaman Admin Organisasi</title>
    <!-- Favicon-->
...
<?php } ?>							
                        ...
                        <div class="body">
                            <form class="form-horizontal" method="POST" action="tambahkeuangan1.php">
                                <div class="row clearfix">
										...
										<label for="email_address_2">Jenis</label>
												...
												<div class="body">
													<div class="demo-radio-button">
														<input name="jenis" value="1" type="radio" id="radio_1"  />
														<label for="radio_1">Pemasukan</label>
														<input name="jenis" value="2"type="radio" id="radio_2" />
														<label for="radio_2">pengeluaran</label>
													</div>
												</div>	
								</div>
								<div class="row clearfix">
                                    ...
                                    <div class="col-lg-10 col-md-10 col-sm-8 col-xs-7">
                                        <div class="form-group">
                                            <div class="form-line">
                                                <input type="text" name="tanggal" id="email_address_2" class="form-control" placeholder="Tahun-Bulan-Tanggal">
                                            </div>
                                        </div>
                                    </div>
                                </div>								
                                <div class="row clearfix">
                                    ...
                                    <div class="col-lg-10 col-md-10 col-sm-8 col-xs-7">
                                        <div class="form-group">
                                            <div class="form-line">
                                                <input type="text" name="nominal" id="email_address_2" class="form-control" placeholder="nominal">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="row clearfix">
                                    ...
                                    <div class="col-lg-10 col-md-10 col-sm-8 col-xs-7">
                                        <div class="form-group">
                                            <div class="form-line">
                                                <input type="text" name="keterangan" id="email_address_2" class="form-control" placeholder="Keterangan" >
                                            </div>
                                        </div>
                                    </div>
                                </div>								
                                <div class="row clearfix">
                                    <div class="col-lg-offset-2 col-md-offset-2 col-sm-offset-4 col-xs-offset-5">
                                         <button type="submit" class="btn btn-primary m-t-15 waves-effect">Masukkan</button>
                                    </div>
                                </div>
