		...
		if ($result = mysqli_query($link, $query))
			{
				if (mysqli_num_rows($result)==0)
					{  
						header ('location:programkerja.php');
					}
			}
	}
					  $id = mysqli_real_escape_string($link, $id);
...
<head>
    ...
    <title>Edit Proker Halaman Admin Organisasi</title>
    <!-- Favicon-->
    ...
    <nav class="navbar">
        <div class="container-fluid">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="index.php">Edit Proker</a>
            </div>
            ...
            <div class="row clearfix">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        ...
                        <div class="body">
                            <form class="form-horizontal" method="POST" action="simpanproker.php">
                                <div class="row clearfix">
                                    ...
                                    <div class="col-lg-10 col-md-10 col-sm-8 col-xs-7">
                                        <div class="form-group">
                                            <div class="form-line">
                                                <input type="text" name="nama" id="email_address_2" class="form-control" value="<?php echo "$namaedit";?>">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="row clearfix">
                                    <div class="col-lg-2 col-md-2 col-sm-4 col-xs-5 form-control-label">
                                        <label for="email_address_2">Tujuan</label>
                                    </div>
                                    <div class="col-lg-10 col-md-10 col-sm-8 col-xs-7">
                                        <div class="form-group">
                                            <div class="form-line">
                                                <input type="text" name="tujuan" id="email_address_2" class="form-control" value="<?php echo "$tujuan"; ?>">
												<input type="hidden" name="id" id="email_address_2" class="form-control" value="<?php echo "$id"; ?>">
                                            </div>
                                        </div>
                                    </div>
                                </div>
										...
										<label for="email_address_2">jenis</label>
												...
												<div class="body">
													<div class="demo-radio-button">
														<input name="jenis" value="mingguan" type="radio" id="radio_1" <?php if ($jenis=='mingguan') {echo 'checked';}?> />
														<label for="radio_1">Mingguan</label>
														<input name="jenis" value="bulanan"type="radio" id="radio_2" <?php if ($jenis=='bulanan') {echo 'checked';}?> />
														<label for="radio_2">Bulanan</label>
														<input name="jenis" value="tahunan"type="radio" id="radio_5" <?php if ($jenis=='tahunan') {echo 'checked';}?> />
														<label for="radio_5">Tahunan</label>
													</div>
												</div>	
								</div>	    
								<div class="row clearfix">
