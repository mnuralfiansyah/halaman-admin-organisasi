...
<head>
    ...
    <title>Catatan Login Halaman Admin Organisasi</title>
    <!-- Favicon-->
                ...
                <div class="info-container">
                    ...
                    <div class="btn-group user-helper-dropdown">
                        ...
                        <ul class="dropdown-menu pull-right">
                            <li><a href="login.php"><i class="material-icons">person</i>Profile</a></li>
...
<?php
		...
		global $link;
		$query="SELECT id, nama, waktulogin, waktulogout  from admin NATURAL JOIN catatanlogin  order by catatanlogin.id desc";
...
?>								
                                    ...
                                    <tr>
										<td width="0" align="left"><?php echo "$id"; ?></td>
                                        <td width="30%" align="left"><?php echo "$nama"; ?></td>
                                        <td width="35%"><?php echo "$waktulogin"; ?></td>
                                        <td width="35%"><?php echo "$waktulogout"; ?></td>
                                    </tr>
