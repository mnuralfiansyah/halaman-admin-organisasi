...
$query_email="SELECT nama, email FROM admin WHERE id_admin=$getid";
$sql_email=mysqli_query($link, $query_email);
$hasil_email=mysqli_fetch_array($sql_email);
...
<body class="theme-red">
    ...
    <section>
        ...
        <aside id="leftsidebar" class="sidebar">
            ...
            <div class="user-info">
                <div class="image">
                    <a href="images/<?php echo "$fotoprofil"; ?>">
						<img src="images/<?php echo "$fotoprofil"; ?>" width="60" height="60" alt="User" />
					</a>	
                </div>
...
<?php if ($jabatan=='Administrator')
		{ ?>								
                            ...
                            <div align="right">
								<a href="tambahanggota.php"  ><button  type="button" class="btn bg-cyan waves-effect"><i class="material-icons">add_person</i><br>Tambah Anggota</button></a>
							</div>
<?php	} ?>	 					
                        </div>
                        <div class="body">
...
<?php
		...
		global $link;
		$query="SELECT aktifitas, waktulogin, waktulogout from admin NATURAL JOIN aktifitasadmin Natural JOIN catatanlogin where admin.id_admin='$getid' order by aktifitasadmin.id desc";
...
?>								
                                    ...
                                    <tr>
                                        <td width="70%" align="left"><?php echo "$aktifitas"; ?></td>
                                        <td width="15%"><?php echo "$waktulogin"; ?></td>
                                        <td width="15%"><?php echo "$waktulogout"; ?></td>
                                    </tr>
