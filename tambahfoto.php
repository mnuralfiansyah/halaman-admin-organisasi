...
<head>
    ...
    <title>Tambah Foto Halaman Admin Organisasi</title>
    <!-- Favicon-->
            ...
            <div class="row clearfix">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        ...
                        <div class="body">
                            <form class="form-horizontal" method="POST" action="tambahfoto1.php" enctype="multipart/form-data">
...
?> 
								<input type="hidden"  name="jumlahfoto" value="<?php echo "$i"; ?>">
							
                 
								
                                <div class="row clearfix">
                                    <div class="col-lg-offset-2 col-md-offset-2 col-sm-offset-4 col-xs-offset-5">
                                         <button type="submit" class="btn btn-primary m-t-15 waves-effect">Tambah Foto</button>
                                    </div>
                                </div>
