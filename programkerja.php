...
<head>
    ...
    <title>Program Kerja Halaman Admin Organisasi</title>
    <!-- Favicon-->
        ...
        <div class="container-fluid">
            <div class="block-header">
				<ol class="breadcrumb breadcrumb-col-pink">
                    <li><a href="javascript:void(0);"><i class="material-icons">bookmark</i> <nsbp>Program Kerja</a></li>
                 </ol>
			</div>
...
<?php if ($jabatan=='Administrator')
		{ ?>								
                            ...
                            <div align="right">
								<a href="tambahprogramkerja.php"  ><button  type="button" class="btn bg-cyan waves-effect"><i class="material-icons">bookmark</i><br>Tambah Data Program Kerja</button></a>
							</div>
<?php	} ?>	 					
                        </div>
                        <div class="body">
...
?>								
                                    ...
                                    <tr>
                                        ...
                                        <td width="35%"><?php echo "$tujuan"; ?></td>
                                        <td width="15%"><?php echo "$jenis"; ?></td>
<?php if (($jabatan=='Administrator') || ($jabatan=='super admin'))
		{ ?>
										<td width="5%">
											<a href="editprogramkerja.php?id=<?php echo "$id";?>"><button type="button" class="btn bg-blue waves-effect"><i class="material-icons">edit</i></button></a>
										</td>
										<td width="5%">
											<a href="deleteprogramkerja.php?id=<?php echo "$id";?>"><button type="button" class="btn bg-red waves-effect"><i class="material-icons">delete</i></button></a>
										</td>
