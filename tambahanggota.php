...
<head>
    ...
    <title>Tambah Anggota Halaman Admin Organisasi</title>
    <!-- Favicon-->
...
<?php if (!empty($eror))
{	?>
							<center><?php echo $eror; ?></center>
<?php } ?>							
                        </div>
                        <div class="body">
                            <form class="form-horizontal" method="POST" action="tambahanggota1.php">
                                ...
                                <div class="row clearfix">
                                    ...
                                    <div class="col-lg-10 col-md-10 col-sm-8 col-xs-7">
                                        <div class="form-group">
                                            <div class="form-line">
                                                <input type="text" name="nama" id="email_address_2" class="form-control" placeholder="Nama Lengkap">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="row clearfix">
                                    ...
                                    <div class="col-lg-10 col-md-10 col-sm-8 col-xs-7">
                                        <div class="form-group">
                                            <div class="form-line">
                                                <input type="text" name="tgl" id="email_address_2" class="form-control" placeholder="HARI/TANGGAL/TAHUN">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="row clearfix">
                                    ...
                                    <div class="col-lg-10 col-md-10 col-sm-8 col-xs-7">
                                        <div class="form-group">
                                            <div class="form-line">
                                                <input type="text" name="alamat" id="email_address_2" class="form-control" placeholder="Jalan, RT, RW, Desa/Kel, Kec, Kab, Prov" >
                                            </div>
                                        </div>
                                    </div>
                                </div>
								<div class="row clearfix">
                                    ...
                                    <div class="col-lg-10 col-md-10 col-sm-8 col-xs-7">
                                        <div class="form-group">
                                            <div class="form-line">
                                                <input type="text" name="telpon" id="email_address_2" class="form-control" placeholder="081234567890">
                                            </div>
                                        </div>
                                    </div>
                                </div>
										...
										<label for="email_address_2">Status</label>
												...
												<div class="body">
													<div class="demo-radio-button">
														<input name="status" value="pengurus" type="radio" id="radio_1"  />
														<label for="radio_1">Pengurus</label>
														<input name="status" value="kader"type="radio" id="radio_2" />
														<label for="radio_2">Kader</label>
														<input name="status" value="simpatisan"type="radio" id="radio_5" />
														<label for="radio_5">Simpatisan</label>
													</div>
												</div>	
								</div>	
                                <div class="row clearfix">
                                    ...
                                    <div class="col-lg-10 col-md-10 col-sm-8 col-xs-7">
                                        <div class="form-group">
                                            <div class="form-line">
                                                <input type="text" name="jabatan" id="email_address_2" class="form-control" placeholder="Jika Ada DiIsi">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="row clearfix">
                                    ...
                                    <div class="col-lg-10 col-md-10 col-sm-8 col-xs-7">
                                        <div class="form-group">
                                            <div class="form-line">
                                                <input type="text" name="keterangan" id="email_address_2" class="form-control" placeholder="Jika Ada DiIsi">
                                            </div>
                                        </div>
                                    </div>
                                </div>
								<div class="row clearfix">
									<div class="col-lg-2 col-md-2 col-sm-4 col-xs-5 form-control-label">
										<label for="email_address_2">Jenis Kelamin</label>
												...
												<div class="body">
													<div class="demo-radio-button">
														<input name="kelamin" value="laki-laki" type="radio" id="radio_3" />
														<label for="radio_3">Laki-Laki</label>
														<input name="kelamin" value="perempuan" type="radio" id="radio_4" />
                                ...
                                <div class="row clearfix">
                                    ...
                                    <div class="col-lg-10 col-md-10 col-sm-8 col-xs-7">
                                        <div class="form-group">
                                            <div class="form-line">
                                                <input type="text" name="email" id="email_address_2" class="form-control" placeholder="email@email.com">
                                            </div>
                                        </div>
                                    </div>
									<div class="col-lg-10 col-md-10 col-sm-8 col-xs-7">
                                        <div class="hide">
                                            <div class="hide">
                                                <input type="text" name="id" id="email_address_2" class="form-control" >
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="row clearfix">
                                    <div class="col-lg-offset-2 col-md-offset-2 col-sm-offset-4 col-xs-offset-5">
                                         <button type="submit" class="btn btn-primary m-t-15 waves-effect">Tambah Anggota</button>
                                    </div>
                                </div>
                            </form>
                        </div>
