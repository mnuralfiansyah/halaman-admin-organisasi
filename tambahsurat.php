...
<?php } ?>							
                        ...
                        <div class="body">
                            <form class="form-horizontal" method="POST" action="tambahsurat1.php">
										...
										<label for="email_address_2">Jenis</label>
												...
												<div class="body">
													<div class="demo-radio-button">
														<input name="jenis" value="Surat Masuk" type="radio" id="radio_1"  />
														<label for="radio_1">Surat Masuk</label>
														<input name="jenis" value="Surat Keluar"type="radio" id="radio_2" />
														<label for="radio_2">Surat Keluar</label>
													</div>
												</div>	
								</div>	
                                <div class="row clearfix">
                                    ...
                                    <div class="col-lg-10 col-md-10 col-sm-8 col-xs-7">
                                        <div class="form-group">
                                            <div class="form-line">
                                                <input placeholder="Tahun/Bulan/Hari" type="text" name="tanggal" id="email_address_2" class="form-control">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="row clearfix">
                                    ...
                                    <div class="col-lg-10 col-md-10 col-sm-8 col-xs-7">
                                        <div class="form-group">
                                            <div class="form-line">
                                                <input placeholder="Nomor Surat" type="text" name="nomor" id="email_address_2" class="form-control" >
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="row clearfix">
                                    <div class="col-lg-2 col-md-2 col-sm-4 col-xs-5 form-control-label">
                                        <label for="email_address_2">Perilhal</label>
                                    </div>
                                    <div class="col-lg-10 col-md-10 col-sm-8 col-xs-7">
                                        <div class="form-group">
                                            <div class="form-line">
                                                <input placeholder="Perihal" type="text" name="perihal" id="email_address_2" class="form-control">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="row clearfix">
                                    <div class="col-lg-offset-2 col-md-offset-2 col-sm-offset-4 col-xs-offset-5">
                                         <button type="submit" class="btn btn-primary m-t-15 waves-effect">Tambah Surat</button>
                                    </div>
                                </div>
                            </form>
                        </div>
