...
$id=$_GET['id'];
	...
	else
	{
		...
		$query ="SELECT * FROM admin WHERE id_admin='$id' && email='$emailsession'";
		$result = mysqli_query ($link, $query);
					  //
		if ($result = mysqli_query($link, $query))
			{
...
<head>
    ...
    <title>Edit Admin Halaman Admin Organisasi</title>
    <!-- Favicon-->
    ...
    <nav class="navbar">
        <div class="container-fluid">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="index.php">Edit Admin</a>
            </div>
            ...
            <div class="row clearfix">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        ...
                        <div class="body">
                            <form class="form-horizontal" method="POST" action="simpanadmin.php">
                                ...
                                <div class="row clearfix">
                                    ...
                                    <div class="col-lg-10 col-md-10 col-sm-8 col-xs-7">
                                        <div class="form-group">
                                            <div class="form-line">
                                                <input type="text" name="email" id="email_address_2" class="form-control" value="<?php echo "$emailedit"; ?>">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row clearfix">
                                    ...
                                    <div class="col-lg-10 col-md-10 col-sm-8 col-xs-7">
                                        <div class="form-group">
                                            <div class="form-line">
                                                <input type="text" name="jabatan" id="email_address_2" class="form-control" value="<?php  echo "$jabatanedit"; ?>">
                                            </div>
                                        </div>
                                    </div>
                                </div>
								...
								<div class="row clearfix">
                                    ...
                                    <div class="col-lg-10 col-md-10 col-sm-8 col-xs-7">
                                        <div class="form-group">
                                            <div class="form-line">
                                                <input type="password" name="passwordlama" id="email_address_2" class="form-control" >
                                            </div>
                                        </div>
                                    </div>
                                </div>
								...
								<div class="row clearfix">
                                    <div class="col-lg-2 col-md-2 col-sm-4 col-xs-5 form-control-label">
                                        <label for="email_address_2">Ulangi Password Baru</label>
                                    </div>
                                    <div class="col-lg-10 col-md-10 col-sm-8 col-xs-7">
                                        <div class="form-group">
                                            <div class="form-line">
                                                <input type="password" name="password1" id="email_address_2" class="form-control" >
                                            </div>
                                        </div>
                                    </div>
                                </div>
